<template>
  <div class="user_container">
    ...
    <el-card class="box-card">
      ...
      <el-row :gutter="20">
        <el-col :span="6">
          <el-button type="primary" @click="showAddDialog" v-has-perm="['info:account:add']">添加账户</el-button>
        </el-col>
      </el-row>
      ...
      <el-table :data="accountList" border stripe>
        ...
        <el-table-column label="操作" width="300px;" align="center" v-if="columnShow">
          <template slot-scope="scope">
            <el-button type="primary" icon="el-icon-edit" size="mini" v-has-perm="['info:account:update']" @click="showEditDialog(scope.row.accountId)">编辑
            </el-button>
            <el-button type="danger" icon="el-icon-delete" size="mini" v-has-perm="['info:account:delete']" @click="deleteAccount(scope.row.accountId)">删除
            </el-button>
          </template>
        </el-table-column>
      </el-table>
