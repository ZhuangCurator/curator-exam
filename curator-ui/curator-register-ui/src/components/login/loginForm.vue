...
<template>
  ...
  <el-form class="login_item" ref="loginFormRef" :model="loginForm" :rules="loginFormRules">
    ...
    <el-form-item prop="password">
      <el-input v-model="loginForm.password" placeholder="请输入用户密码" type="password" prefix-icon="iconfont icon-mima"></el-input>
    </el-form-item>
    <!-- 图片验证码 -->
    <el-form-item prop="imageCode">
      <el-input v-model="loginForm.imageCode" prefix-icon="iconfont icon-yanzhengma" class="validate_input"
...
export default {
  ...
  methods: {
    ...
    async getValidateCodeImage () {
      ...
      if (res.status === '20000') {
        this.validateCodeImage = res.data.image
